...
[![Demo](https://img.shields.io/badge/🚀_Live_Demo-Try_Now-brightgreen.svg)](https://hanzoe.github.io/I-PIN)
[![Conference](https://img.shields.io/badge/MobiCom-2026-blue.svg)](https://www.sigmobile.org/mobicom/2026/)
[![Paper](https://img.shields.io/badge/📄_Paper-PDF-red.svg)](https://hanzoe.github.io/I-PIN/paper.pdf)
[![Status](https://img.shields.io/badge/Status-Code_Restructuring-orange.svg)](https://github.com/hanzoe/I-PIN)

> **⚠️ Code Restructuring in Progress**: This repository is currently undergoing major code restructuring and optimization. The codebase is being reorganized for better maintainability and production readiness. Please refer to the [Interactive Research Demo](https://hanzoe.github.io/I-PIN) for complete research details and technical analysis.
...
git clone https://github.com/Hanzoe/I-PIN.git
cd I-PIN
...
**[📊 Full Research Demo & Paper Details](https://hanzoe.github.io/I-PIN)**
...
|----------|------|-------------|
| **📄 Paper** | **[PDF Download](https://hanzoe.github.io/I-PIN/paper.pdf)** | **MobiCom 2026 submission** |
| **🔬 Research Demo** | **[Interactive Demo](https://hanzoe.github.io/I-PIN)** | **Full research visualization** |
| **💻 GitHub** | **[@Hanzoe](https://github.com/Hanzoe)** | **Source code repository** |
| **📧 Issues** | **[Report Bug](https://github.com/Hanzoe/I-PIN/issues)** | **Bug reports and feature requests** |

### 📧 **Contact Information**

- **Primary Contact**: [Contact via GitHub](https://github.com/Hanzoe)
